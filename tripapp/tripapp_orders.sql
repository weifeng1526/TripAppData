...
CREATE TABLE `orders` (
  ...
  `prod_pic` blob,
  PRIMARY KEY (`ord_no`),
  KEY `orders_memno_FK` (`mem_no`),
  KEY `orders_prodno_FK` (`prod_no`),
  CONSTRAINT `orders_memno_FK` FOREIGN KEY (`mem_no`) REFERENCES `member` (`mem_no`),
  CONSTRAINT `orders_prodno_FK` FOREIGN KEY (`prod_no`) REFERENCES `product` (`prod_no`)
