...
('sophia@tip102.com', 'sophia', '888888', 1);
...
(2, 1, 1, '日本東京', '日本', '2024-12-31', '2025-01-06', 'JPY',null, '2024-11-30 00:00:00'),
...
(8, 5, 1, '台南古城美食之旅', '台灣', '2025-03-25', '2025-03-27', 'TWD', null, '2025-02-20 00:00:00');

-- 台北三天兩夜 (sch_no = 1)
INSERT INTO dest (sch_no, poi_no, dst_name, dst_addr, dst_dep, dst_date, dst_start, dst_end, dst_inr)
VALUES
(1, 10, '台北101', '台北市信義區市府路45號', '地標景點', '2025-01-25', '09:30:00', '01:30:00', '00:30:00'),
(1, 11, '象山', '台北市信義區松山路', '健行與拍照', '2025-01-25', '11:30:00', '01:30:00', '00:30:00'),
(1, 12, '中正紀念堂', '台北市中正區中山南路21號', '歷史與文化', '2025-01-25', '13:30:00', '02:30:00', '00:30:00'),
(1, 13, '士林夜市', '台北市士林區文林路', '美食與夜市文化', '2025-01-25', '16:30:00', '01:00:00', '00:00:00'),

(1, 14, '陽明山國家公園', '台北市北投區竹子湖路1-20號', '自然景觀', '2025-01-26', '10:00:00', '01:30:00', '01:00:00'),
(1, 15, '地熱谷', '台北市北投區中山路2號', '溫泉與拍照', '2025-01-26', '12:30:00', '01:30:00', '00:30:00'),
(1, 16, '故宮博物院', '台北市士林區至善路二段221號', '文物欣賞', '2025-01-26', '14:30:00', '01:00:00', '01:30:00'),
(1, 17, '士林官邸', '台北市士林區中山北路5段60號', '歷史與園藝', '2025-01-26', '17:00:00', '01:30:00', '00:00:00'),

(1, 18, '北投溫泉博物館', '台北市北投區中山路2號', '溫泉文化', '2025-01-27', '09:30:00', '01:30:00', '00:30:00'),
(1, 19, '大稻埕碼頭', '台北市大同區延平北路大稻埕', '景觀與午餐', '2025-01-27', '11:30:00', '03:00:00', '00:30:00'),
(1, 20, '西門町', '台北市萬華區峨嵋街36號', '購物與娛樂', '2025-01-27', '15:00:00', '03:30:00', '00:00:00');

-- 日本五天四夜 (sch_no = 2)
INSERT INTO dest (sch_no, poi_no, dst_name, dst_addr, dst_dep, dst_date, dst_start, dst_end, dst_inr)
VALUES
    -- 2023-11-20
    (2, 1, '道頓堀', '大阪府大阪市中央區道頓堀', '大阪', '2025-01-20', '09:00:00', '10:30:00', '00:30:00'),
    (2, 2, '梅田地鐵站', '大阪府大阪市北區梅田', '大阪', '2025-01-20', '11:00:00', '11:30:00', '00:30:00'),
    (2, 3, '大阪城', '大阪府大阪市中央區大阪城1-1', '大阪', '2025-01-20', '12:00:00', '13:30:00', '00:30:00'),
    (2, 4, '道頓堀美食街', '大阪府大阪市中央區道頓堀', '大阪', '2025-01-20', '14:00:00', '15:30:00', '00:30:00'),
    (2, 5, '通天閣', '大阪府大阪市浪速區惠美須東1丁目18-6', '大阪', '2025-01-20', '16:00:00', '17:00:00', null),

    -- 2023-11-21
    (2, 6, '環球影城', '大阪府大阪市此花區櫻島2丁目1-33', '大阪', '2025-01-21', '09:00:00', '15:00:00', '01:00:00'),
    (2, 7, '難波飯店', '大阪府大阪市浪速區難波', '大阪', '2025-01-21', '16:00:00', '17:00:00', '00:30:00'),
    (2, 8, '日本橋商店街', '大阪府大阪市中央區日本橋', '大阪', '2025-01-21', '17:30:00', '18:30:00', '00:30:00'),
    (2, 9, '黑門市場', '大阪府大阪市中央區日本橋2丁目4-1', '大阪', '2025-01-21', '19:00:00', '20:00:00', '00:30:00'),
    (2, 10, '道頓堀夜景', '大阪府大阪市中央區道頓堀', '大阪', '2025-01-21', '20:30:00', '21:30:00',  null),

    -- 2023-11-22
    (2, 11, '心齋橋商圈', '大阪府大阪市中央區心齋橋', '大阪', '2025-01-22', '10:00:00', '11:30:00', '00:30:00'),
    (2, 12, '天保山摩天輪', '大阪府大阪市港區海岸通1丁目1-10', '大阪', '2025-01-22', '12:00:00', '13:00:00', '00:30:00'),
    (2, 13, '大阪海遊館', '大阪府大阪市港區海岸通1丁目1-10', '大阪', '2025-01-22', '13:30:00', '15:00:00', '00:30:00'),
    (2, 14, '心齋橋', '大阪府大阪市中央區心齋橋', '大阪', '2025-01-22', '15:30:00', '16:30:00', '00:30:00'),
    (2, 15, '道頓堀晚餐', '大阪府大阪市中央區道頓堀', '大阪', '2025-01-22', '17:00:00', '18:30:00',  null),

    -- 2023-11-23
    (2, 16, '黑門市場早餐', '大阪府大阪市中央區日本橋', '大阪', '2025-01-23', '09:00:00', '10:00:00', '00:30:00'),
    (2, 17, '天王寺動物園', '大阪府大阪市天王寺區茶臼山町1-108', '大阪', '2025-01-23', '10:30:00', '12:00:00', '00:30:00'),
    (2, 18, '四天王寺', '大阪府大阪市天王寺區四天王寺1-11-18', '大阪', '2025-01-23', '12:30:00', '14:00:00', '01:00:00'),
    (2, 19, '天王寺車站', '大阪府大阪市天王寺區悲田院町', '大阪', '2025-01-23', '14:30:00', '15:00:00', '00:30:00'),
    (2, 20, '阿倍野Harukas', '大阪府大阪市阿倍野區阿倍野筋1丁目1-43', '大阪', '2025-01-23', '15:30:00', '17:00:00',  null),

    -- 2023-11-24
    (2, 21, '大阪市中央公會堂', '大阪府大阪市北區中之島1丁目1-27', '大阪', '2025-01-24', '09:00:00', '10:30:00', '00:30:00'),
    (2, 22, '中之島公園', '大阪府大阪市北區中之島1丁目1', '大阪', '2025-01-24', '11:00:00', '12:30:00', '01:00:00'),
    (2, 23, '新大阪旅館', '大阪府大阪市淀川區西中島', '大阪', '2025-01-24', '18:00:00', '19:00:00', '00:30:00'),
    (2, 24, '心齋橋', '大阪府大阪市中央區心齋橋', '大阪', '2025-01-24', '20:00:00', '21:00:00', '00:30:00'),
	(2, 25, '關西國際機場', '大阪府泉佐野市泉州空港北1', '大阪', '2025-01-24', '22:00:00', '23:00:00', null);
    
-- 台中兩天一夜 (sch_no = 3)
INSERT INTO dest (sch_no, poi_no, dst_name, dst_addr, dst_dep, dst_date, dst_start, dst_end, dst_inr)
VALUES
(3, 1, '宮原眼科', '台中市中區中山路20號', '甜點與打卡景點', '2025-02-25', '09:00:00', '01:00:00', '00:30:00'),
(3, 2, '草悟道', '台中市西區民權路', '散步與拍照', '2025-02-25', '10:30:00', '01:30:00', '00:30:00'),
(3, 3, '台中勤美誠品', '台中市西區公益路68號', '購物與午餐', '2025-02-25', '12:30:00', '02:30:00', '00:30:00'),
(3, 4, '彩虹眷村', '台中市南屯區春安路56號', '文創藝術', '2025-02-25', '15:30:00', '02:30:00', '00:30:00'),
(3, 5, '逢甲夜市', '台中市西屯區福星路', '美食與夜市文化', '2025-02-25', '18:30:00', '02:00:00', '00:00:00'),

(3, 6, '高美濕地', '台中市清水區美堤街', '自然景觀', '2025-02-26', '08:00:00', '01:00:00', '01:00:00'),
(3, 7, '薰衣草森林', '台中市新社區中興嶺', '放鬆與拍照', '2025-02-26', '10:00:00', '01:00:00', '01:00:00'),
(3, 8, '一中街商圈', '台中市北區育才北路', '購物與午餐', '2025-02-26', '12:00:00', '01:30:00', '00:30:00'),
(3, 9, '科學博物館', '台中市北區館前路1號', '科普與探索', '2025-02-26', '14:00:00', '02:00:00', '00:00:00');
...
(2, 1, '高雄探索之旅', '台灣', '2025-02-05', '2025-02-08', 'TWD', NULL, '2025-01-09 00:00:00'),
-- Member 3 trips
(3, 1, '北海道滑雪冒險', '日本', '2025-01-05', '2025-01-10', 'JPY', NULL, '2025-01-09 00:00:00'),
...
(4, 1, '高雄港口假期', '台灣', '2025-05-10', '2025-05-15', 'TWD', NULL, '2025-01-09 00:00:00'),
-- Member 5 trips

-- Member 6 trips
(6, 1, '京都櫻花巡禮', '日本', '2025-01-25', '2025-01-30', 'JPY', NULL, '2025-01-09 00:00:00'),
-- Member 7 trips
(7, 1, '花蓮太魯閣假期', '台灣', '2025-04-01', '2025-04-05', 'TWD', NULL, '2025-01-09 00:00:00'),
